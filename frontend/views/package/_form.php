...
<div class="package-form">
    ...
    if(!$model->isNewRecord && $main_img=$model->image) {
        $iniImg=[Html::img("@web/images/package/".$model->id."/s_".$main_img, ['class'=>'file-preview-image', 'alt'=>''])];
        $url=Url::to(['site/img-delete', 'id' => $model->id, 'model_name'=>'package']);
    ...
    echo $form->field($model, 'imageFile')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            ...
            'previewFileType' => 'any',
            'uploadUrl' => Url::to(['/package/img-upload','id'=>$model->id]),
